...
public class CashfreeVerificationService {
	...
	private final String URL_GSTIN="https://sandbox.cashfree.com/verification/gstin";
	private final String baseurl="https://sandbox.cashfree.com/";
	//@Value( "${cashfree.api.version}")
	private final String apiversion="2.0";

	//@Value("${cashfree.client-id}")
	private final String ClientId="CF10148842CP5GM2PBRFKLVP14O2DG";

	//@Value("${cashfree.client-secret}")
	private final String ClientSecret="cfsk_ma_test_2bb3fcb7c0632ccc067a90069a667b5f_b37ad93b";
